          ...
          <TooltipProvider>
            <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
              ...
              >
                ...
                <span className="sr-only">ReviewLar</span>
              </Link>
              <Tooltip>
...
// Componente wrapper que decide se mostra o layout ou não
function LayoutWrapper({ children }: { children: React.ReactNode }) {
  const pathname = usePathname();
  const isLoginPage = pathname === '/admin/login';

  return isLoginPage ? <>{children}</> : <AdminAppLayout>{children}</AdminAppLayout>;
}
