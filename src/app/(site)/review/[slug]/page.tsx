...
import { ShieldCheck, Zap, Info, ShoppingCart } from 'lucide-react';
...
import AdSenseAd from '@/components/adsense-ad'; // Já importado!
  ...
  return (
    <>
      ...
      <main className="flex-1 bg-white dark:bg-card">
        {/* 📢 ALTERAÇÃO AQUI: Novo grid de 3 colunas (xl) */}
        <div className="container mx-auto px-4 py-8 md:py-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 lg:gap-8 xl:gap-12">
            
            {/* 🆕 COLUNA DA ESQUERDA - ANÚNCIOS (Visível apenas em XL e acima) */}
            <aside className="hidden xl:block xl:col-span-2 lg:sticky lg:top-24 self-start">
              <div className="space-y-6">
                <div className="border rounded-lg p-4 bg-muted/20">
                  ...
                  <AdSenseAd 
                    adSlot="2453817336" // 👈 SUBSTITUÍDO PELO SEU SLOT
                    adFormat="vertical"
            ...
            {/* ARTIGO PRINCIPAL (Reduzido para 7 colunas em XL) */}
            ...
            {/* COLUNA DA DIREITA - REVIEWS RELACIONADOS (Mantido em 3 colunas em XL) */}
        ...
        {/* Botão Flutuante de Compra - Visível apenas no mobile */}
